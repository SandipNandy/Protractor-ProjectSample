...
let Rec_Reviewersanity = function () {
    ...
    let selectreviewer = element(by.xpath("//div[contains(@class,'mat-select-panel mat-primary')]")).element(by.xpath("//mat-option/span[contains(text(),' Reviewer ')]"));
    this.select_reviewer = function () {
    ...
    let PresenceofRecGroupReviewer=element(by.css("[ref='eCenterContainer'] div[row-index='0']"));
    this.Presence_ofRecGroup_Reviewer=function(){
         return PresenceofRecGroupReviewer;
    };
...
module.exports = new Rec_Reviewersanity();